...
class Solution:
    def LCA(self, root, n1, n2):
        # your code here
        while root:
            if n1.data < root.data and n2.data < root.data:  # Move left
                root = root.left
            elif n1.data > root.data and n2.data > root.data:  # Move right
                root = root.right
            else:
                return root  # This is the LCA node
        return None  # If somehow nodes are not found (edge case)
