<h2><a href="https://www.geeksforgeeks.org/problems/operations-on-queue/1?page=1&category=Stack,Queue&sortBy=difficulty">Operations on Queue</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a queue of <strong>integers </strong>and <strong>Q</strong> queries. The task is to perform operations on queue according to the query.&nbsp;</span></p>
