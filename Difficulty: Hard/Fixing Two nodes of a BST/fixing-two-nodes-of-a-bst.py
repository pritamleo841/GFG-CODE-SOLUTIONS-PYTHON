    ...
    def correctBST(self, root):
        ...
        def inorder(node):
            ...
            if prev and node.data<prev.data:
                if not first:
                    first=prev
                    middle=node  # Potential adjacent swap
                else:
                    last=node  # Second incorrect node
        ...
        # Fix swapped nodes
        if first and last:
            first.data,last.data=last.data,first.data  # Non-adjacent swap
        elif first and middle:
            first.data,middle.data=middle.data,first.data  # Adjacent swap

        return root  # Return corrected BST
