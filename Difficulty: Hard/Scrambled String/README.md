<h2><a href="https://www.geeksforgeeks.org/problems/scrambled-string/1?page=13&category=Tree,Binary%20Search%20Tree,DFS,BFS&sortBy=difficulty">Scrambled String</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two strings&nbsp;<strong>S1</strong>&nbsp;and&nbsp;<strong>S2</strong>&nbsp;of equal length, the task is to determine if S2 is a scrambled form of S1.</span></p>
